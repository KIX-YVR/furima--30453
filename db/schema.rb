...
ActiveRecord::Schema.define(version: 2020_12_01_145015) do
  ...
  create_table "addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_info_id"], name: "index_addresses_on_purchase_info_id"
  end
  ...
  add_foreign_key "addresses", "purchase_infos"
